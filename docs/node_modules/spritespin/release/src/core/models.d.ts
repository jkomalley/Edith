...
export declare type Callback = (e: any, data: Data) => void;
/**
...
export declare type SizeMode = 'original' | 'fit' | 'fill' | 'stretch';
export declare type RenderMode = 'canvas' | 'image' | 'background';
